...
//  TableView
//
//  Created by Rian Sanjaya Ng on 06/08/18.
...
class EmojiTableTableViewController: UITableViewController {
    ...
    var emojis: [Emoji] = [
        ...
        Emoji(symbol: "😕", name: "Confused Face", description: "A confused, puzzle face", usage: "unsure what to think, displeasure"),
...
//        navigationItem.leftBarButtonItem = editButtonItem
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "EditEmoji" {
            ...
            let addEditEmojiTableViewController = segue.destination.childViewControllers[0] as! AddEditEmojiTableViewController
